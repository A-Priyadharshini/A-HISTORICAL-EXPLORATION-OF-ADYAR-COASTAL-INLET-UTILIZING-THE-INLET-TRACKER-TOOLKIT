...
sitename = 'ADYAR' #user input required
site_shapefile_name = 'input_adyar1507' #user input required | change this if a new shapefile was created with the site configurations
...
dates = ['1993-01-01', '2023-12-01']   #user input required
...
settings = { 
    ...
    'shapefile_EPSG' : 7785,     #epsg of shapefile containing sites and path finding seed and receiver points
